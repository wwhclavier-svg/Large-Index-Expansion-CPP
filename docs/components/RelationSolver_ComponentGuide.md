...
- [algorithms/ReconstructAlgorithm.md](algorithms/ReconstructAlgorithm.md) — Algorithm comparison: MMA vs C++, per-point evaluation (computeG/computeF1/computeF2), symbolic vs numerical approaches
...
- `AnsatzModes.md` — Ansatz 模式详解（Pyramid/DotPyramid/Star/Extended）
