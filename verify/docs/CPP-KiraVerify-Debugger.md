...
根据 LIE 理论（LIE Notes, Reconstruct_Algorithm.md §1.2），IBP 关系方程的形式为：
...
- `/root/Large-Index-Expansion-CPP/tests/test_relationFF.cpp` — 已恢复正确的 g-format 输出
- `/root/Large-Index-Expansion-CPP/verify/bub00/Relations_*.m` — 9 个正确格式的关系文件
- `/root/Large-Index-Expansion-CPP/verify/bub00/Compare-CPPRelation-*.m` — 9 个正确格式的比较文件
- `/root/Large-Index-Expansion-CPP/verify/scripts/NuVerify-Relations.wl` — MMA 验证脚本（期望 g 格式）
