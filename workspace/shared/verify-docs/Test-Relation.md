...
| `families/FamilyDatabase.wl` | Family definitions |
...
**Specialist variant:** `workspace/shared/VerifyUtility/Verify-Series.wl` — detailed per-(lev,deg) verification with region-aware pAlpha/theta.
...
| `workspace/shared/VerifyUtility/KiraRuleLoader.wl` | Rule loader library |

### Generating Kira Rules

**Step 1: Kira input via M2Kira.wl**
```mathematica
<< "workspace/shared/VerifyUtility/M2Kira.wl"
...
| `workspace/shared/VerifyUtility/Verify-Blade.wl` | BladeVerify module |
| `workspace/shared/VerifyUtility/Verify-Series.wl` | SeriesVerify module |
| `workspace/shared/VerifyUtility/Verify-Kira.wl` | KiraVerify module |
| `workspace/shared/VerifyUtility/Verify-MMACompare.wl` | MMACompare module (placeholder) |
| `families/FamilyDatabase.wl` | Family configs (19 families) |
| `workspace/shared/VerifyUtility/KiraRuleLoader.wl` | Kira rule loader |
| `Test-Expand.md` | Expansion verification docs |
| `/home/ykm/blade-workspace/Blade.wl` | Blade IBP library |
