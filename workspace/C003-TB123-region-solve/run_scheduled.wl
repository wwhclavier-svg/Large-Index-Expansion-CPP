...
Print["========================================"];
Print["ScheduledRegionSolve TB123"];
...
Get[$FamilyDBPath];
If[!KeyExistsQ[$FamilyDatabase, "TB123"],
  Print["ERROR: TB123 not found in FamilyDatabase"];
  Exit[1]
];
...
ibpFile = FileNameJoin[{$ProjectRoot, "IBPMat_TB123.bin"}];
ringFile = FileNameJoin[{$ProjectRoot, "RingData_TB123.bin"}];
Print["\nOutput files:"];
...
Print["\n========================================"];
Print["ScheduledRegionSolve TB123 complete."];
Print["========================================"];
