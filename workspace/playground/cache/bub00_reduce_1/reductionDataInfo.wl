...
If[!ContainsAll[all,target],
  ...
  Put[{{},target,MappedSectors[bub00],UniqueSectors[bub00],Table[{ii},{ii,Length@target}]}, FileNameJoin@{resdir, "datainfo"}];
...
eqs=(Import[#]/.{s -> 3, msq -> 0, "d" -> 1/3})&/@eqsfiles;
nids=Length/@eqs;
...
Put[{nonmis,mis,MappedSectors[bub00],UniqueSectors[bub00],ConstantArray[{},Length[nonmis]]}, FileNameJoin@{resdir, "datainfo"}];
Abort[]];
...
Put[{nonmis,mis,MappedSectors[bub00],UniqueSectors[bub00],sparseinfo}, FileNameJoin@{resdir, "datainfo"}];
Put[usints,FileNameJoin@{resdir, "usints"}];
Put[exints,FileNameJoin@{resdir,"exints"}];
