...
If[!ContainsAll[all,target],
  ...
  Put[{{},target,MappedSectors[Penta1L5m],UniqueSectors[Penta1L5m],Table[{ii},{ii,Length@target}]}, FileNameJoin@{resdir, "datainfo"}];
...
eqs=(Import[#]/.{s12 -> 1, s23 -> 2, s34 -> 3, s45 -> 5, s15 -> 8, msq -> 11, "d" -> 1/3})&/@eqsfiles;
nids=Length/@eqs;
...
Put[{nonmis,mis,MappedSectors[Penta1L5m],UniqueSectors[Penta1L5m],ConstantArray[{},Length[nonmis]]}, FileNameJoin@{resdir, "datainfo"}];
Abort[]];
...
Put[{nonmis,mis,MappedSectors[Penta1L5m],UniqueSectors[Penta1L5m],sparseinfo}, FileNameJoin@{resdir, "datainfo"}];
Put[usints,FileNameJoin@{resdir, "usints"}];
Put[exints,FileNameJoin@{resdir,"exints"}];
