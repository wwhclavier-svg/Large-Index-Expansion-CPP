...
SetOptions[AutoDetermine,"CutNoDot" -> False, "MaxIncrement" -> 5, "StartingPower" -> 2, "HighestPower" -> 5, "CheckSymmetry" -> True, "Nthreads" -> 8];


SetOptions[AutoDetermine,"GenCutIds" -> GenCutIds, "LinearReduce" -> FFLinearSolveLearn];


SetOptions[AutoDetermine,"Numeric"->{s -> 3/2, msq -> 1}];
