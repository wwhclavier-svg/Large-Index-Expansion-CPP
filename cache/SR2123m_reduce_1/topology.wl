...
NewBasis[SR2123m,Propagators,Internal, External, MomentumConservation, Replacements,"ExtraIntDeriv"->{{{0}, {0}, {0}, {0}, {0}}}];
AnalyzeSectors[SR2123m,{1, 0, 1, 0, 1},"CutDs"->{0, 0, 0, 0, 0},"Prescription"->{1, 1, 1, 1, 1},"CloseSyms"->False,"ExtSyms"->True];
